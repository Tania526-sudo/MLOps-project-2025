...
print("CHECKPOINT:")
print("File exists (raw):", os.path.exists(RAW_FILE_PATH))
print("File exists (train):", os.path.exists(TRAIN_FILE_PATH))
print("File exists (test):", os.path.exists(TEST_FILE_PATH))
